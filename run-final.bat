@echo off
echo REALFORGE AI - One Command Startup (Final)
echo ===========================================
echo.
...
REM Install Python dependencies (simplified for MVP)
...
REM Start Next.js with fixed WebSocket config
echo 🌐 Starting Next.js (with WebSocket fix)...
...
echo   - Close them individually OR
echo   - Press any key here to kill all services
echo.

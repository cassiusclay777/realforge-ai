                    ...
                    <div className="aspect-square relative">
                      ...
                      <div className="absolute inset-0 bg-black/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center p-4">
                        <div className="text-center">
                          ...
                          {item.aiCaption && (
                            <div className="mb-3">
                              <p className="text-white/90 text-sm font-sans tracking-tight line-clamp-2">
                                "{item.aiCaption}"
                              </p>
                            </div>
                          )}
                          
                          {/* AI popis (detailnější) */}
                          {item.aiDescription && (
                            <div className="mb-3">
                              <p className="text-white/80 text-xs font-sans tracking-tight line-clamp-3">
                                {item.aiDescription}
                              </p>
                            </div>
                          )}
                      ...
                      {/* AI popisek na spodku fotky (viditelný vždy) */}
                      {item.aiCaption && (
                        <div className="absolute bottom-0 left-0 right-0 p-2 bg-gradient-to-t from-black/80 to-transparent">
                          <p className="text-white text-xs font-sans tracking-tight line-clamp-1">
                            {item.aiCaption}
                          </p>
                        </div>
                      )}

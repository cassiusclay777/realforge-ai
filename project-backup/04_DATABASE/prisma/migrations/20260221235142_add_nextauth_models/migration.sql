...
-- AlterTable
ALTER TABLE "CRMLead" ALTER COLUMN "status" SET DEFAULT 'NEW';

-- AlterTable
ALTER TABLE "ExportJob" ALTER COLUMN "status" SET DEFAULT 'PREPARING';

-- AlterTable
ALTER TABLE "Listing" ALTER COLUMN "status" SET DEFAULT 'NEW';
